    ...
    variants.forEach((variant, variantIndex) => {
        ...
        allDivergences.forEach(div => {
            ...
            if (variant.showNumbers) {
                traces.push({
                x: [div.date],
                y: [div.low - (div.low * ((variant.numberPosition || 4) / 200))], // Numbers positioned based on variant setting
                mode: 'text',
                type: 'scatter',
            ...
            if (variant.showSuccessRate) {
                ...
                if (successData.success !== null) {
                    ...
                    traces.push({
                        x: [div.date],
                        y: [div.low - (div.low * ((variant.successPosition || 8) / 200))], // Success positioned based on variant setting
                        mode: 'text',
                        type: 'scatter',
                        text: [successText],
            ...
            traces.push({
                x: [div.date],
                y: [div.rsi - (rsiRange * ((variant.numberPosition || 4) / 200))], // Numbers positioned based on variant setting
                mode: 'text',
                type: 'scatter',
            ...
            traces.push({
                x: [div.date],
                y: [div.macd - (macdRange * ((variant.numberPosition || 4) / 200))], // Numbers positioned based on variant setting
                mode: 'text',
                type: 'scatter',
            ...
            if (dateIndex > variant.window && shouldShowDetails) {
                ...
                traces.push({
                    ...
                    line: { color: variant.color, width: variant.lineWidth || 1.5, dash: 'dash', shape: 'spline' },
                    xaxis: 'x',
                    yaxis: 'y',
                    legendgroup: `${variant.name}_${div.divType}_${isBullish ? 'bullish' : 'bearish'}`,
                    showlegend: false,
                ...
                if (variant.showNames) {
                    traces.push({
                    x: [div.date],
                    y: [div.low - (div.low * ((variant.namePosition || 6) / 200))], // Names positioned based on variant setting
                    mode: 'text',
                    type: 'scatter',
                ...
                traces.push({
                    x: [div.date],
                    y: [div.rsi - (rsiRange * ((variant.namePosition || 6) / 200))], // Names positioned based on variant setting
                    mode: 'text',
                    type: 'scatter',
                ...
                traces.push({
                    x: [div.date],
                    y: [div.macd - (macdRange * ((variant.namePosition || 6) / 200))], // Names positioned based on variant setting
                    mode: 'text',
                    type: 'scatter',
