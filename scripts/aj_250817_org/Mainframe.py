...
for i in range(2, len(df)):
    if df['CBullD_gen'][i] == 1:
        fplt.plot(pd.to_datetime(df['CBullD_Lower_Low_date_gen'][i]), df['CBullD_Lower_Low_gen'][i], style='x', ax=ax1, color='red')
        fplt.plot(pd.to_datetime(df['CBullD_Higher_Low_date_gen'][i]), df['CBullD_Higher_Low_gen'][i], style='x', ax=ax1, color='blue')

        fplt.plot(pd.to_datetime(df['CBullD_Lower_Low_date_gen'][i]), df['CBullD_Lower_Low_RSI_gen'][i], style='x', ax=ax2, color='red')
        fplt.plot(pd.to_datetime(df['CBullD_Higher_Low_date_gen'][i]), df['CBullD_Higher_Low_RSI_gen'][i], style='x', ax=ax2, color='blue')

        fplt.plot(pd.to_datetime(df['CBullD_Lower_Low_date_gen'][i]), df['CBullD_Lower_Low_MACD_gen'][i], style='x', ax=ax3, color='red')
        fplt.plot(pd.to_datetime(df['CBullD_Higher_Low_date_gen'][i]), df['CBullD_Higher_Low_MACD_gen'][i], style='x', ax=ax3, color='blue')

    if df['CBullD_neg_MACD'][i] == 1:
        fplt.plot(pd.to_datetime(df['CBullD_Lower_Low_date_neg_MACD'][i]), df['CBullD_Lower_Low_neg_MACD'][i], style='x', ax=ax1, color='red')
        fplt.plot(pd.to_datetime(df['CBullD_Higher_Low_date_neg_MACD'][i]), df['CBullD_Higher_Low_neg_MACD'][i], style='x', ax=ax1, color='blue')

        fplt.plot(pd.to_datetime(df['CBullD_Lower_Low_date_neg_MACD'][i]), df['CBullD_Lower_Low_RSI_neg_MACD'][i], style='x', ax=ax2, color='red')
        ...
        fplt.plot(pd.to_datetime(df['CBullD_Lower_Low_date_neg_MACD'][i]), df['CBullD_Lower_Low_MACD_neg_MACD'][i], style='x', ax=ax3, color='red')
