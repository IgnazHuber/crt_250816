...
@app.route('/api/export_validation', methods=['POST'])
def export_validation():
    """🔧 Exportiert Validierungsdaten als XLSX"""
    try:
        data = request.json
        session_id = data.get('session_id')
        ...
        filepath = Path('exports') / f'validation_{session_id}.xlsx'
        result = engine.export_validation_to_xlsx(results, filepath)
