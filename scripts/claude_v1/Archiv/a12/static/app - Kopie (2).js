...
function showChart(data) {
    ...
    chartInstance.on('plotly_click', function(data) {
    ...
    let html = `
        <div class="validation-header">
            ...
            <div class="validation-meta">
                ...
                <span class="validation-strength" style="color: ${getStrengthColor(validation.strength_score)};">
                    💪 Stärke: ${validation.strength_score}%
                </span>
            </div>
        </div>
    `;
