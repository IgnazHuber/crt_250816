    ...
    if (index < variants.length) {
        switch(type) {
            ...
            case 'names':
                ...
                // Names require complete replot since they're not in legend
            ...
            case 'numbers':
                ...
                // Numbers require complete replot since they're not in legend
                if (window.currentResults && sessionId) {
                    plotChart(window.currentChartData, window.currentResults);
                    return;
                }
            ...
            case 'circles':
                ...
                // Circles require complete replot since they're not in legend
                if (window.currentResults && sessionId) {
                    plotChart(window.currentChartData, window.currentResults);
                    return;
                }
...
function plotChart(chartData, results) {
    ...
    variants.forEach((variant, variantIndex) => {
        ...
        allDivergences.forEach(div => {
            ...
            // Add highlighting circle for variant differences (if enabled)
            if (div.is_new === true && variantIndex > 0 && variant.showCircles) {
            ...
            // Add RSI highlighting circle for variant differences (if enabled)
            if (div.is_new === true && variantIndex > 0 && variant.showCircles) {
                traces.push({
                    x: [div.date],
                    y: [div.rsi],
            ...
            // Add MACD highlighting circle for variant differences (if enabled)
            if (div.is_new === true && variantIndex > 0 && variant.showCircles) {
                traces.push({
                    x: [div.date],
                    y: [div.macd],
        ...
        if (variantIndex > 0 && firstVariantDivergences && variants[0].showCircles) {
