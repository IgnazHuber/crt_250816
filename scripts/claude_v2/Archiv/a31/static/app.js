...
function simulateBullishTradingStrategy(chartData, allBullishSignals, startingCapital = 10000, stopLossPercent = 5, takeProfitPercent = 25) {
...
function plotChart(chartData, results) {
    ...
    if (tradingEnabled) {
        // Get user-defined trading parameters
        const stopLossPercent = parseFloat(document.getElementById('stopLoss').value) || 5;
        const takeProfitPercent = parseFloat(document.getElementById('takeProfit').value) || 25;
        ...
        // Run trading simulation for this variant with user parameters
        if (variantBullishSignals.length > 0) {
            const tradingResult = simulateBullishTradingStrategy(chartData, variantBullishSignals, 10000, stopLossPercent, takeProfitPercent);
