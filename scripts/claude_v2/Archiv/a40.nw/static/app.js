    ...
    fileInput.addEventListener('change', async (e) => {
        ...
        try {
            ...
            if (data.success) {
                ...
                showMessage('uploadMsg', `${data.rows} rows loaded (${data.performance_mode})`, 'success');
                analyzeBtn.disabled = false;
                
                // Update data timeframe display
                if (data.info && data.info.date_range) {
...
function plotChart(chartData, results) {
    ...
    try {
        ...
        // Use Plotly.react instead of newPlot to preserve interactivity
