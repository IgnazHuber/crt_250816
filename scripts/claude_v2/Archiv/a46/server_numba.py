...
USE_NUMBA_OPTIMIZATION = False  # Toggle between original and Numba-optimized functions - DISABLED: using working claude_v1 modules
...
if not USE_NUMBA_OPTIMIZATION:
    ...
    try:
        ...
        logger.info("CBullDivg_Analysis_vectorized.py loaded (claude_v1 correct version)")
    except ImportError:
