...
def _doe_plot_by_type(df_counts, single_pages=False, asset_label=None):
    """
...
def run_doe_analysis(df, doe_params_file="doe_parameters_example.csv",
    ...
    if all_counts_rows:
        ...
        if make_total:
            _doe_plot_total(df_counts, asset_label=asset_label)          # optional Gesamt-Heatmap
        _doe_plot_by_type(df_counts, single_pages=make_single, asset_label=asset_label)   # Facet (immer)
