...
# Paths
csv_file_path = r'C:\Anirudh\Python\IBKR\New_Layout\Daily_India\output_KOTAKBANK_1day.csv'
output_dir = r'C:\Anirudh\Python\IBKR\Incremental\KOTAKBANK\output_daily_parquet_lookback_alltime'
