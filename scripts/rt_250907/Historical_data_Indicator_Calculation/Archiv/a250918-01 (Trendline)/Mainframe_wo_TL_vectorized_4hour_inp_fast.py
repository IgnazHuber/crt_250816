...
if __name__ == '__main__':
    ...
    CBullDivg_analysis(df_full, 0.05, 3.25)
    CBullDivg_x2_analysis(df_full, 0.05, 3.25)
    HBullDivg_analysis(df_full, 0.05, 3.25)
    CBearDivg_analysis(df_full, 0.05, 3.25)
    HBearDivg_analysis(df_full, 0.05, 3.25)
