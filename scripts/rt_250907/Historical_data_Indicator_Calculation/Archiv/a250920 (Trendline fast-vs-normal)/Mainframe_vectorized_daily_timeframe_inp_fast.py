...
# Ensure main process performs selection
...
def process_i(i):
    # Slice of original dataset, then run full indicator pipeline to match legacy behaviour
    df = _get_df_full().iloc[:i].copy()

    # Run indicator pipeline exactly as original module
